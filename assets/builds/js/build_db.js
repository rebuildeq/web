...
function initBuilds() {
    ...
    war.set(0, new Build( // tree 1 row 1 left
        "Shield Wall",
        "Increases your block chance by 2% per rank.",
        "/builds/images/builds/icons/rb-todo.png"
    )) // RB_WAR_SHIELDWALL

    war.set(2, new Build( // tree 1 row 1 right
        "Fortitude",
        "Reduces damage taken by 1% per rank.",
        "/builds/images/builds/icons/rb-todo.png"
    )) // RB_WAR_FORTITUDE
    ...
    rng.set(0, new Build( // tree 1 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-todo.png"
    )) // RB_RNG_FLETCHING
    ...
    rog.set(0, new Build( // tree 1 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-rog-appraisal.png"
    )) // RB_ROG_APPRAISAL
    ...
    rog.set(8, new Build( // tree 1 row 3 right
        ...
        icon = "/builds/images/builds/icons/rb-rog-sneakattack.png"
    )) // RB_ROG_SNEAKATTACK
    ...
    rog.set(10, new Build( // tree 1 row 4 middle
        ...
        icon = "/builds/images/builds/icons/rb-rog-focusedstab.png"
    )) // RB_ROG_FOCUSEDSTAB

    rog.set(13, new Build( // tree 1 row 5 middle
        title = "Vital Organs",
        description = "The base damage for Backstab increases by 10% per rank.",
        icon = "/builds/images/builds/icons/rb-rog-vitalorgans.png"
    )) // RB_ROG_VITALORGANS
    ...
    rog.set(16, new Build( // tree 1 row 6 middle
        ...
        icon = "/builds/images/builds/icons/rb-rog-assassinstaint.png"
    ...
    rog.set(18, new Build( // tree 2 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-rog-sleightdistraction.png"
    ...
    rog.set(20, new Build( // tree 2 row 1 right
        ...
        icon = "/builds/images/builds/icons/rb-rog-jarringstab.png"
    )) // RB_ROG_JARRINGSTAB
    ...
    rog.set(22, new Build( // tree 2 row 2 middle
        ...
        icon = "/builds/images/builds/icons/rb-rog-untappedpotential.png"
    ...
    rog.set(24, new Build( // tree 2 row 3 left
        ...
        icon = "/builds/images/builds/icons/rb-rog-confuse.png"
    )) // RB_ROG_CONFUSE
    ...
    rog.set(26, new Build( // tree 2 row 3 right
        ...
        icon = "/builds/images/builds/icons/rb-rog-gangstersparadise.png"
    ...
    rog.set(28, new Build( // tree 2 row 4 middle
        ...
        icon = "/builds/images/builds/icons/rb-rog-mossstone.png"
    )) // RB_ROG_MOSSSTONE
    ...
    rog.set(31, new Build( // tree 2 row 5 middle
        ...
        icon = "/builds/images/builds/icons/rb-rog-duelist.png"
    )) // RB_ROG_DUELIST
    ...
    rog.set(34, new Build( // tree 2 row 6 middle
        ...
        icon = "/builds/images/builds/icons/rb-rog-escape.png"
    )) // RB_ROG_ESCAPE
    ...
    rog.set(36, new Build( // tree 3 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-rog-sleightofstrength.png"
    ...
    rog.set(38, new Build( // tree 3 row 1 right
        ...
        icon = "/builds/images/builds/icons/rb-rog-haggle.png"
    )) // RB_ROG_HAGGLE
    ...
    rog.set(40, new Build( // tree 3 row 2 middle
        ...
        icon = "/builds/images/builds/icons/rb-rog-hiddenstash.png"
    )) // RB_ROG_HIDDENSTASH
    ...
    rog.set(42, new Build( // tree 3 row 3 left
        ...
        icon = "/builds/images/builds/icons/rb-rog-throwingprecision.png"
    ...
    rog.set(49, new Build( // tree 3 row 5 middle
        ...
        icon = "/builds/images/builds/icons/rb-rog-thievesaffinity.png"
    ...
    rog.set(52, new Build( // tree 3 row 6 middle
        ...
        icon = "/builds/images/builds/icons/rb-rog-hiddendagger.png"
    )) // RB_ROG_HIDDENDAGGER
    ...
    shm.set(0, new Build( // tree 1 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-shm-spiritofspeed.png"
    ...
    shm.set(2, new Build( // tree 1 row 1 right
        ...
        icon = "/builds/images/builds/icons/rb-shm-purifysoul.png"
    )) // RB_SHM_PURIFYSOUL
    ...
    shm.set(4, new Build( // tree 1 row 2 middle
        ...
        icon = "/builds/images/builds/icons/rb-shm-ancestralaid.png"
    )) // RB_SHM_ANCESTRALAID
    ...
    shm.set(6, new Build( // tree 1 row 3 left
        ...
        icon = "/builds/images/builds/icons/rb-shm-extendedhaste.png"
    ...
    shm.set(8, new Build( // tree 1 row 3 right
        ...
        icon = "/builds/images/builds/icons/rb-shm-spiritualhealing.png"
    ...
    shm.set(10, new Build( // tree 1 row 4 middle
        ...
        icon = "/builds/images/builds/icons/rb-shm-covenantofspirit.png"
    ...
    shm.set(13, new Build( // tree 1 row 5 middle
        ...
        icon = "/builds/images/builds/icons/rb-shm-reinforcetorpor.png"
    ...
    shm.set(16, new Build( // tree 1 row 6 middle
        ...
        icon = "/builds/images/builds/icons/rb-shm-fateseersboon.png"
    ...
    shm.set(18, new Build( // tree 2 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-shm-cannibalize.png"
    )) // RB_SHM_CANNIBALIZE
    ...
    shm.set(20, new Build( // tree 2 row 1 right
        ...
        icon = "/builds/images/builds/icons/rb-shm-spiritcall.png"
    )) // RB_SHM_SPIRITCALL
    ...
    shm.set(22, new Build( // tree 2 row 2 middle
        ...
        icon = "/builds/images/builds/icons/rb-shm-virulentparalysis.png"
    ...
    shm.set(24, new Build( // tree 2 row 3 left
        ...
        icon = "/builds/images/builds/icons/rb-shm-poison.png"
    )) // RB_SHM_POISON
    ...
    shm.set(26, new Build( // tree 2 row 3 right
        ...
        icon = "/builds/images/builds/icons/rb-shm-extendedturgur.png"
    ...
    shm.set(28, new Build( // tree 2 row 4 middle
        ...
        icon = "/builds/images/builds/icons/rb-shm-ancientwrath.png"
    )) // RB_SHM_ANCIENTWRATH
    ...
    shm.set(31, new Build( // tree 2 row 5 middle
        ...
        icon = "/builds/images/builds/icons/rb-shm-turgursecho.png"
    )) // RB_SHM_TURGURSECHO
    ...
    shm.set(34, new Build( // tree 2 row 6 middle
        ...
        icon = "/builds/images/builds/icons/rb-shm-spiritualchanneling.png"
    ...
    shm.set(36, new Build( // tree 3 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-shm-fury.png"
    )) // RB_SHM_FURY
    ...
    shm.set(38, new Build( // tree 3 row 1 right
        ...
        icon = "/builds/images/builds/icons/rb-shm-rabidbear.png"
    )) // RB_SHM_RABIDBEAR
    ...
    shm.set(40, new Build( // tree 3 row 2 middle
        ...
        icon = "/builds/images/builds/icons/rb-shm-ancestralguard.png"
    ...
    shm.set(42, new Build( // tree 3 row 3 left
        ...
        icon = "/builds/images/builds/icons/rb-shm-calloftheancients.png"
    ...
    shm.set(44, new Build( // tree 3 row 3 right
        ...
        icon = "/builds/images/builds/icons/rb-shm-spiritualwrath.png"
    ...
    shm.set(46, new Build( // tree 3 row 4 middle
        ...
        icon = "/builds/images/builds/icons/rb-shm-markofsloth.png"
    )) // RB_SHM_MARKOFSLOTH
    ...
    shm.set(49, new Build( // tree 3 row 5 middle
        ...
        icon = "/builds/images/builds/icons/rb-shm-feralswipe.png"
    )) // RB_SHM_FERALSWIPE
    ...
    shm.set(52, new Build( // tree 3 row 6 middle
        ...
        icon = "/builds/images/builds/icons/rb-shm-paragonofspirit.png"
    ...
    mag.set(0, new Build( // tree 1 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-mag-summoningfocus.png"
    ...
    mag.set(2, new Build( // tree 1 row 1 right
        ...
        icon = "/builds/images/builds/icons/rb-mag-quicksummoning.png"
    ...
    mag.set(4, new Build( // tree 1 row 2 middle
        ...
        icon = "/builds/images/builds/icons/rb-mag-improvedreclaimenergy.png"
    ...
    mag.set(6, new Build( // tree 1 row 3 left
        ...
        icon = "/builds/images/builds/icons/rb-mag-modulationshard.png"
    ...
    mag.set(8, new Build( // tree 1 row 3 right
        ...
        icon = "/builds/images/builds/icons/rb-mag-companionsdurability.png"
    ...
    mag.set(10, new Build( // tree 1 row 4 middle
        ...
        icon = "/builds/images/builds/icons/rb-mag-suspendedminion.png"
    ...
    mag.set(13, new Build( // tree 1 row 5 middle
        ...
        icon = "/builds/images/builds/icons/rb-mag-mendcompanion.png"
    ...
    mag.set(16, new Build( // tree 1 row 6 middle
        ...
        icon = "/builds/images/builds/icons/rb-mag-companionofnecessity.png"
    ...
    mag.set(18, new Build( // tree 2 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-mag-sharedhealth.png"
    )) // RB_MAG_SHAREDHEALTH
    ...
    mag.set(20, new Build( // tree 2 row 1 right
        ...
        icon = "/builds/images/builds/icons/rb-mag-hostintheshell.png"
    ...
    mag.set(22, new Build( // tree 2 row 2 middle
        ...
        icon = "/builds/images/builds/icons/rb-mag-turnsummoned.png"
    )) // RB_MAG_TURNSUMMONED
    ...
    mag.set(24, new Build( // tree 2 row 3 left
        ...
        icon = "/builds/images/builds/icons/rb-mag-frenziedburnout.png"
    ...
    mag.set(26, new Build( // tree 2 row 3 right
        ...
        icon = "/builds/images/builds/icons/rb-mag-elementalalacrity.png"
    ...
    mag.set(28, new Build( // tree 2 row 4 middle
        ...
        icon = "/builds/images/builds/icons/rb-mag-callofthehero.png"
    ...
    mag.set(31, new Build( // tree 2 row 5 middle
        ...
        icon = "/builds/images/builds/icons/rb-mag-clockworkmerchant.png"
    ...
    mag.set(34, new Build( // tree 2 row 6 middle
        ...
        icon = "/builds/images/builds/icons/rb-mag-servantofro.png"
    )) // RB_MAG_SERVANTOFRO
    ...
    mag.set(36, new Build( // tree 3 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-mag-dimensionalshield.png"
    ...
    mag.set(38, new Build( // tree 3 row 1 right
        ...
        icon = "/builds/images/builds/icons/rb-mag-heartofstone.png"
    )) // RB_MAG_HEARTOFSTONE
    ...
    mag.set(40, new Build( // tree 3 row 2 middle
        ...
        icon = "/builds/images/builds/icons/rb-mag-heartofvapor.png"
    )) // RB_MAG_HEARTOFVAPOR
    ...
    mag.set(42, new Build( // tree 3 row 3 left
        ...
        icon = "/builds/images/builds/icons/rb-mag-shockofswords.png"
    ...
    mag.set(44, new Build( // tree 3 row 3 right
        ...
        icon = "/builds/images/builds/icons/rb-mag-heartofice.png"
    )) // RB_MAG_HEARTOFICE
    ...
    mag.set(46, new Build( // tree 3 row 4 middle
        ...
        icon = "/builds/images/builds/icons/rb-mag-quickdamage.png"
    )) // RB_MAG_QUICKDAMAGE
    ...
    mag.set(49, new Build( // tree 3 row 5 middle
        ...
        icon = "/builds/images/builds/icons/rb-mag-heartofflames.png"
    ...
    mag.set(52, new Build( // tree 3 row 6 middle
        ...
        icon = "/builds/images/builds/icons/rb-mag-primalfusion.png"
    )) // RB_MAG_PRIMALFUSION
    ...
    enc.set(0, new Build( // tree 1 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-enc-nightmare.png"
    )) // RB_ENC_NIGHTMARE
    ...
    enc.set(2, new Build( // tree 1 row 1 right
        ...
        icon = "/builds/images/builds/icons/rb-enc-cripplingpresence.png"
    ...
    enc.set(4, new Build( // tree 1 row 2 middle
        ...
        icon = "/builds/images/builds/icons/rb-enc-soothingwords.png"
    ...
    enc.set(6, new Build( // tree 1 row 3 left
        ...
        icon = "/builds/images/builds/icons/rb-enc-mindovermatter.png"
    ...
    enc.set(8, new Build( // tree 1 row 3 right
        ...
        icon = "/builds/images/builds/icons/rb-enc-beneficialdispell.png"
    ...
    enc.set(10, new Build( // tree 1 row 4 middle
        ...
        icon = "/builds/images/builds/icons/rb-enc-persuasion.png"
    )) // RB_ENC_PERSUASION
    ...
    enc.set(13, new Build( // tree 1 row 5 middle
        ...
        icon = "/builds/images/builds/icons/rb-enc-choke.png"
    )) // RB_ENC_CHOKE

    enc.set(16, new Build( // tree 1 row 6 middle
        title = "Drown",
        description = "Lowers mana cost of DoTs by 3% tick per rank.",
        icon = "/builds/images/builds/icons/rb-enc-drown.png"
    )) // RB_ENC_DROWN
    ...
    enc.set(18, new Build( // tree 2 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-enc-enthrall.png"
    )) // RB_ENC_ENTHRALL
    ...
    enc.set(20, new Build( // tree 2 row 1 right
        ...
        icon = "/builds/images/builds/icons/rb-enc-tash.png"
    )) // RB_ENC_TASH
    ...
    enc.set(22, new Build( // tree 2 row 2 middle
        ...
        icon = "/builds/images/builds/icons/rb-enc-backfire.png"
    )) // RB_ENC_BACKFIRE
    ...
    enc.set(28, new Build( // tree 2 row 4 middle
        ...
        icon = "/builds/images/builds/icons/rb-enc-focus.png"
    )) // RB_ENC_FOCUS
    ...
    enc.set(31, new Build( // tree 2 row 5 middle
        ...
        icon = "/builds/images/builds/icons/rb-enc-lifeflow.png"
    )) // RB_ENC_LIFEFLOW
    ...
    enc.set(34, new Build( // tree 2 row 6 middle
        ...
        icon = "/builds/images/builds/icons/rb-enc-direcharm.png"
    )) // RB_ENC_DIRECHARM
    ...
    enc.set(36, new Build( // tree 3 row 1 left
        ...
        icon = "/builds/images/builds/icons/rb-enc-entropy.png"
    )) // RB_ENC_ENTROPY
    ...
    enc.set(38, new Build( // tree 3 row 1 right
        ...
        icon = "/builds/images/builds/icons/rb-enc-colorshock.png"
    )) // RB_ENC_COLORSHOCK
    ...
    enc.set(40, new Build( // tree 3 row 2 middle
        ...
        icon = "/builds/images/builds/icons/rb-enc-manaspear.png"
    )) // RB_ENC_MANASPEAR
    ...
    enc.set(42, new Build( // tree 3 row 3 left
        ...
        icon = "/builds/images/builds/icons/rb-enc-flowingthought.png"
    ...
    enc.set(44, new Build( // tree 3 row 3 right
        ...
        icon = "/builds/images/builds/icons/rb-enc-subtlecasting.png"
    ...
    enc.set(46, new Build( // tree 3 row 4 middle
        ...
        icon = "/builds/images/builds/icons/rb-enc-badmoon.png"
    )) // RB_ENC_BADMOON
    ...
    enc.set(49, new Build( // tree 3 row 5 middle
        ...
        icon = "/builds/images/builds/icons/rb-enc-tranquility.png"
    )) // RB_ENC_TRANQUILITY
    ...
    enc.set(52, new Build( // tree 3 row 6 middle
        ...
        icon = "/builds/images/builds/icons/rb-enc-reclaim.png"
    )) // RB_ENC_RECLAIM
